...
def resend_otp(label, remaining_time_var):
    ...
    con = gmail.GMail("", "")
    print(x)
    otp_gen = gmail.Message(to="nitishkumarpandey78@gmail.com", subject="OTP", text=f"Your OTP is: {x}")
    con.send(otp_gen)
...
title.pack()
footer=Label(win,text=f'Copyright 2024 \u00A9; Designed By Nitish Pandey',font=('arial',13,'bold','underline'),bg='powder blue')
...
callback("https://www.facebook.com/profile.php?id=100012402932641"))
...
label_img.bind("<Button-1>", lambda e:
callback("https://www.instagram.com/nitish_pandey78/"))
...
label_img.bind("<Button-1>", lambda e:
callback("https://www.linkedin.com/in/nitish-kumar-pandey-58b327236/"))
